...
## 1.15.0
* Added support for external packages in HTTP collections and folders.
* Added an option to beautify code in pre-request and post-response scripts.

## 1.14.0
* Support for External Packages in Request

## 1.13.1
* Add and manage CA and client certificates

## 1.12.1
* Fixed issue with `setNextRequest` in scripts

## 1.12.0
* Edit Postman scripts as a file in the IDE
* Support for type definitions of packages in script editor
