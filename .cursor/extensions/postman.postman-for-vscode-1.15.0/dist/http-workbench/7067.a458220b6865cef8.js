"use strict";(self.webpackChunkhttp_workbench=self.webpackChunkhttp_workbench||[]).push([[7067],{67067:(e,n,l)=>{l.r(n),l.d(n,{FileUploader:()=>Pe,KeyValueEditor:()=>ml});var t=l(7560),i=l(40540),o=l.n(i),s=l(59530),a=l.n(s),r=l(78476),d=l(50297),c=l(98283),u=l(74269),h=l(69356),p=l.n(h),b=l(22833),g=l.n(b),v=l(80519),f=l(52322);let m,x,y=e=>e;const C=a().div(m||(m=y`
  position: relative;
  display: flex;
...
`),(({size:e})=>`var(--size-${Ae[e]})`));function Pe(e){return(0,f.jsx)(Ee.VW,{children:(0,f.jsx)(Te.Toast.Ui.ToastEventEmitter,{children:(0,f.jsx)(Fe,(0,t.Z)({},e))})})}function Fe(e){const{value:n,onReset:l,id:t,label:o,name:s,multiple:a,isDisabled:r,loading:d,error:c,accept:u,autoFocus:h,onChange:p,size:b="small",alignSelf:g="center"}=e;let v;if((0,i.useEffect)((()=>{c&&Te.Toast.getToasts().addToast({status:"error",title:Me,description:c})}),[c]),null!=n&&n.length){const e=n.length,t=n[0],i=n.join(", "),o=e>1?`${e} files selected`:`${t}`;v=(0,f.jsx)(de.Z,{content:i,children:(0,f.jsx)(Oe,{size:b,children:(0,f.jsx)(Se.Af,{label:o,onClick:l})})})}else v=(0,f.jsx)(Te.FileUploader,{id:t,onChange:e=>{!r&&e&&(null==p||p(e))},multiple:a,isDisabled:r,accept:u,name:s,actionLabel:o,autoFocus:h,size:b,loading:d});return(0,f.jsx)(We,{direction:"column",alignItems:"center",alignSelf:g,children:v})}const ze=()=>{const e=(0,i.useRef)(!0);return(0,i.useEffect)((()=>()=>{e.current=!1}),[]),e};let Be;const $e="Select Files",Ne=a()(Ve.Z)(Be||(Be=(e=>e)`
  padding: var(--spacing-xs);
`));function He(e){const{id:n,type:l,value:t,hidden:o,error:s,onFilesSelect:a,onChange:r}=e,[d,c]=(0,i.useState)(!1),u=ze(),h=(0,i.useMemo)((()=>Array.isArray(t)?t:t?[t]:[]),[t]);return o?null:(0,f.jsx)(Ne,{height:"100%",width:"100%",children:(0,f.jsx)(Pe,{label:$e,id:String(n),multiple:!0,error:s,value:h,loading:d,onChange:e=>{a&&(c(!0),a(n,e).finally((()=>{u.current&&c(!1)})))},onReset:()=>null==r?void 0:r(l,"")})})}const Le=e=>e.disableEdit,Ie=(e,n)=>n||e.system&&!e.allowedToToggle,Ke=(e,n)=>!e.disableEdit&&!(null!=n&&n.disableToggle)||e.system;var _e=l(95362),Ue=l(70262);let Xe;const Ye=a().div(Xe||(Xe=(e=>e)`
...
`),(({alwaysPresent:e})=>e?"1":"0"));function qe({onClick:e,maskState:n,isVisible:l}){const t=!1===n.isMasked;return(0,f.jsx)(Ye,{role:"button",className:"toggle-mask","aria-label":"toggle-mask-row",onClick:e,alwaysPresent:t||l,children:n.isMasked?(0,f.jsx)(_e.Z,{}):(0,f.jsx)(Ue.Z,{})})}var Ge=l(64691),Je=l(48263),Qe=l(80605),en=l(59824),nn=l(17282),ln=l(29225);const tn=e=>{const{onPersist:n,onReset:l,disableVariablePersistAction:t,disablePersistActionTooltip:i,disableResetActionTooltip:o,disableVariableResetAction:s}=e,a=(e=!1,n)=>{if(e){let e;switch(n){case"persist":e=i;break;case"reset":e=o}return e||"You do not have permissions to perform this action."}return null};return(0,f.jsxs)(Ge.Z,{children:[(0,f.jsx)(Je.Z,{children:(0,f.jsx)(Qe.Z,{icon:(0,f.jsx)(ln.Z,{size:"small"}),type:"tertiary",tooltip:"View more actions",size:"small","data-testid":"more-options-button"})}),(0,f.jsxs)(en.Z,{placement:"bottom-end",children:[(0,f.jsx)(nn.Z,{onClick:n,isDisabled:t,tooltip:a(t,"persist"),children:"Persist"}),(0,f.jsx)(nn.Z,{onClick:l,isDisabled:s,tooltip:a(s,"reset"),children:"Reset"})]})]})};let on;const sn=a().div(on||(on=(e=>e)`
  display: flex;
  flex-direction: row;
  opacity: ${0};
  margin-right: var(--spacing-xs);
`),(({isVisible:e})=>e?"1":"0")),an=({isHidden:e=!1,children:n,isVisible:l})=>e||!n?null:(0,f.jsx)(sn,{isVisible:l,children:n});var rn=l(26246);const dn=["warning"],cn=["prevValue","prevCurrentWidth"],un=["nextValue","nextCurrentWidth"];let hn,pn,bn,gn,vn=e=>e;const fn=a().div(hn||(hn=vn`
  display: flex;
  flex-direction: row;
  position: relative;
  flex: 0;
  ...
  background-color: ${0};
  color: ${0};
`),(e=>e.isRowFocused?"var(--background-color-secondary) !important":e.isRowSelected||e.disabled?"var(--background-color-secondary)":"inherit"),(e=>e.disabled?"var(--content-color-tertiary)":"inherit")),mn=a().div(pn||(pn=vn`
  position: relative;
  display: flex;
  flex: 1;
  min-width: 0;
  flex-direction: row;
  color: ${0};
`),(e=>e.isBlocked?"var(--content-color-tertiary)":"inherit")),xn=a().div(bn||(bn=vn`
  display: flex;
  align-items: center;
  cursor: pointer;
  border-right: var(--border-width-default) var(--border-style-solid)
...
`)),Cn=new Map;Cn.set("default",{value:ie,label:"default"}),Cn.set("secret",{value:te,label:"secret"});const wn=[Cn.get("default"),Cn.get("secret")];function kn(e){const{index:n,value:l,onChange:o,onRemove:s,currentWidth:a,showColumns:r,allowedColumns:d,enableFiles:u,onFilesSelect:h,maskState:p,toggleMaskValue:b,hideVariableTypeDropdown:g,onPersist:v,onReset:m,onBlur:x,enableVariableSuggestions:y,optionsDropdownValues:C,isDuplicated:w}=e,j=(0,i.useRef)(o);j.current=o;let{key:V,value:E,sessionValue:D="",options:R,type:Z,enabled:M=!0,description:A="",fileUploadError:W}=l;const O=Z===te?te:ie,F=r.includes("variableType")?O:Z||"text",[z,B]=(0,i.useState)(null),[$,N]=(0,i.useState)(null),H=null!==z,L=(0,i.useMemo)((()=>{var e;return null!=(e=le.find((e=>e.value===l.type)))?e:le[0]}),[l.type]),I=(0,i.useCallback)(((e,n)=>{"sessionValue"===e&&void 0!==n&&l.isSessionValueDeleted&&(null==j.current||j.current((0,t.Z)({},l,{[e]:n,isSessionValueDeleted:!1})));const i="type"===e&&["text","file"].includes(n);null==j.current||j.current((0,t.Z)({},l,i&&{value:""},{[e]:n}))}),[l]),K=(0,i.useCallback)((e=>{(0,c.Z)(l,dn),I("enabled",e)}),[l,I]),_=(0,i.useCallback)((()=>{s&&s()}),[s]),U=(0,i.useCallback)((n=>e[`nonEditable${T(n)}s`]),[e]);function X(e){return Number(a[null==r?void 0:r.indexOf(e)])}return(0,f.jsxs)(fn,{role:"row","aria-rowindex":n,disabled:Le(l),isRowSelected:e.isRowSelected,isRowFocused:null!==z,onMouseEnter:()=>N(!0),onMouseLeave:()=>N(!1),children:[(0,f.jsx)(k,{disabled:e.disableSorting&&e.nonEditableToggles,shouldShowCheckbox:Ke(l,e),isRowEnabled:M,onToggleEnabledState:K,isCheckboxDisabled:Ie(l,e.nonEditableToggles)}),(0,f.jsxs)(mn,{isBlocked:l.disableEdit,children:[(0,f.jsx)(S,{columnWidth:X("key"),isNonEditable:U("key"),isLastColumn:r&&"key"===r[r.length-1],content:(0,f.jsx)(be,{type:"key",value:V,currentWidth:X("key"),onFocus:()=>B("key"),onChange:I,isEditable:"key"===z,placeholder:e.keyPlaceholder,preventEnter:e.disableMultilineKey||!1,readOnly:l.disableEdit||e.nonEditableKeys,shouldFocusOnMount:!0,onBlur:()=>B(null),isDuplicated:w,actions:(0,f.jsx)(je,{hidden:!$||!u,options:le,defaultOption:L,onChange:e=>I("type",e.value)}),indicators:(0,f.jsx)(Ce,{infoTitle:l.infoTitle,info:l.info,placement:"right"}),enableVariableSuggestions:y})}),r.includes("variableType")&&(0,f.jsx)(S,{columnWidth:X("variableType"),isNonEditable:U("variableType"),isLastColumn:r&&"variableType"===r[r.length-1],content:(!g||e.nonEditableVariableTypes)&&(0,f.jsx)(yn,{isRowFocused:H,tabIndex:-1,isDisabled:e.nonEditableVariableTypes,onChange:async l=>{const{disableAllVariablesSync:t=!1,disableSecretVariablesSync:i}=e;if(Z===l.value)return;if(t||!i&&l.value===te||i&&l.value===te&&!E)return I("type",l.value),void(b&&b(n));const o=rn.Modals.getModals(),s=await o.showWarningDialog({uid:"kv-editor-variable-type-change-confirmation",subject:`Change ${V}'s type to ${l.value}?`,message:"This will reveal the hidden values in plain text everywhere in the app for all team members",options:[{title:"Cancel",isDefaultOnDismiss:!0},{title:"Change type",isPrimary:!0}]});return s&&"Change type"===s.title?(I("type",l.value),void(b&&b(n))):void 0},options:wn,value:Cn.get(F),isClearable:!1,isSearchable:!1,menuWidth:100,viaPortal:!0})}),r.includes("value")&&(0,f.jsx)(S,{columnWidth:X("value"),isNonEditable:U("value"),isLastColumn:r&&"value"===r[r.length-1],content:(0,f.jsxs)(f.Fragment,{children:[(0,f.jsx)(be,{hidden:"file"===Z,type:"value",value:E,currentWidth:X("value"),onFocus:()=>B("value"),onChange:I,isEditable:"value"===z,placeholder:e.valuePlaceholder,preventEnter:e.disableMultilineValue||!1,readOnly:l.disableEdit||e.nonEditableValues,shouldFocusOnMount:!0,onBlur:()=>("value",B(null),void(x&&x("value",l))),editorType:Z,maskState:p,enableVariableSuggestions:y}),(0,f.jsx)(He,{hidden:"file"!==Z,id:n,type:"value",value:E,error:W,onChange:I,onFilesSelect:h})]})}),r.includes("description")&&(0,f.jsx)(S,{columnWidth:X("description"),isNonEditable:U("description"),isLastColumn:r&&"description"===r[r.length-1],content:(0,f.jsx)(be,{type:"description",value:A,onChange:I,placeholder:e.descriptionPlaceholder,isEditable:"description"===z,currentWidth:X("description"),onFocus:()=>B("description"),readOnly:l.disableEdit||e.nonEditableDescriptions,shouldFocusOnMount:!0,onBlur:()=>B(null)})}),r.includes("sessionValue")&&(0,f.jsx)(S,{columnWidth:X("sessionValue"),isNonEditable:U("sessionValue"),isLastColumn:r&&"sessionValue"===r[r.length-1],content:(0,f.jsx)(be,{type:"sessionValue",value:D,onChange:I,isEditable:"sessionValue"===z,placeholder:l.isSessionValueDeleted?"[Deleted]":e.sessionValuePlaceholder,preventEnter:e.disableMultilineValue||!1,currentWidth:X("sessionValue"),onFocus:()=>B("sessionValue"),readOnly:l.disableEdit||e.nonEditableSessionValue,shouldFocusOnMount:!0,onBlur:()=>B(null),editorType:Z,maskState:p,enableVariableSuggestions:y})}),r.includes("options")&&(0,f.jsx)(S,{columnWidth:X("options"),isNonEditable:U("options"),isLastColumn:r&&"options"===r[r.length-1],content:(0,f.jsx)(yn,{isRowFocused:H,tabIndex:-1,onChange:e=>I("options",e),options:C,value:R,isClearable:!1,isSearchable:!1,menuWidth:100})}),(0,f.jsx)(xn,{children:((null==r?void 0:r.includes("value"))||(null==r?void 0:r.includes("description"))||(null==r?void 0:r.includes("sessionValue")))&&!e.isRowSelected&&!e.value.disableEdit&&(0,f.jsxs)(f.Fragment,{children:[F===te&&(0,f.jsx)(qe,{isVisible:$,maskState:p,onClick:()=>b(n)}),(0,f.jsxs)(an,{isHidden:H,isVisible:$,children:[!e.disableDelete&&(0,f.jsx)(P,{onClick:_}),!e.disableVariableRowDropdown&&d.includes("sessionValue")&&(0,f.jsx)(tn,{onPersist:v,onReset:m,disableVariablePersistAction:e.disableVariablePersistAction||e.disableSecretVariablesSync&&F===te,disablePersistActionTooltip:e.disablePersistActionTooltip,disableVariableResetAction:e.disableVariableResetAction||e.disableSecretVariablesSync&&F===te,disableResetActionTooltip:e.disableResetActionTooltip})]})]})})]})]})}const jn=(0,i.memo)(kn,((e,n)=>{const{prevValue:l,prevCurrentWidth:t}=e,i=(0,c.Z)(e,cn),{nextValue:o,nextCurrentWidth:s}=n,a=(0,c.Z)(n,un);return!!p()(l,o)&&(!!p()(i,a)&&!!D(t,s))}));var Vn=l(49437),En=l(80047);const Sn=["values","disableSorting","onChange","onRemove","disableDelete","disableCreate","disableToggle","keyPlaceholder","valuePlaceholder","descriptionPlaceholder","disableVariableRowDropdown","currentWidth","maskStatesMap","toggleMaskValue","onPersist","onReset","onBlur","filteredIndices","searchValue","enableScroll","duplicateWarningsMap"];let Tn;const Dn=a().div(Tn||(Tn=(e=>e)`
  display: flex;
  flex: 1;
...
`),(({enableScroll:e})=>e&&"overflow: overlay;"));function Rn(e){let{values:n,disableSorting:l,onChange:o,onRemove:s,disableDelete:a,disableCreate:r,disableToggle:d,keyPlaceholder:u,valuePlaceholder:h,descriptionPlaceholder:p,disableVariableRowDropdown:b,currentWidth:g,maskStatesMap:v,toggleMaskValue:m,onPersist:x,onReset:y,onBlur:C,filteredIndices:w,searchValue:k,enableScroll:j,duplicateWarningsMap:V}=e,E=(0,c.Z)(e,Sn);const S=(0,i.useCallback)(((e,n)=>{o&&o(e,n)}),[o]),T=(0,i.useCallback)((e=>{s&&s(e)}),[s]),D=k&&w?w.map((e=>n[e])):n;return(0,f.jsx)(Dn,{enableScroll:j,children:k&&0===D.length?(0,f.jsx)("div",{className:"key-value-form-editor-sortable",children:(0,f.jsx)(Vn.Z,{title:"No results found",children:(0,f.jsx)(En.Z,{name:"illustration-search"})})}):D&&D.map(((e,i)=>{var o,s;const c=e.id===(null==n?void 0:n.length)-1;return(0,f.jsx)(jn,(0,t.Z)({index:i,selectableKey:e.id,value:e,onChange:n=>S(e.id,n),onRemove:()=>T(e.id),onPersist:()=>{return n=e.id,void(x&&x(n));var n},onReset:()=>{return n=e.id,void(y&&y(n));var n},onBlur:(n,l)=>((e,n,l)=>{C&&C(e,n,l)})(e.id,n,l),disableSorting:l||c,disableToggle:d||c&&!r,disableDelete:a||c&&!r,disableVariableRowDropdown:b||c&&!r,keyPlaceholder:c&&u,valuePlaceholder:c&&h,descriptionPlaceholder:c&&p,hideVariableTypeDropdown:!r&&c,currentWidth:g,maskState:!(!r&&c)&&(v&&v[e.id]||{isMasked:e.type===te}),isDuplicated:V&&V[e.id].isOverridden,toggleMaskValue:m},E),null!=(o=null==(s=e.id)?void 0:s.toString())?o:i)}))})}var Zn=l(70355);function Mn(e,n=100){return e/n*100}function An(e,n=2){return Math.round(e*Math.pow(10,n))/Math.pow(10,n)}let Wn;const On=500,Pn=a().div(Wn||(Wn=(e=>e)`
  height: 32px;
  width: 16px;
  margin-left: -8px;
  background-color: transparent;
  ...
  cursor: col-resize;
  z-index: 1;
`),(e=>e.left)),Fn=e=>{const{showColumns:n,currentWidth:l,prevColumn:t,nextColumn:o,parentWidth:s=On,handleResize:a}=e,r=(0,i.useCallback)((e=>{const t=null==n?void 0:n.indexOf(e);if(-1===t)return 0;let i=0;for(let e=0;e<=t;e++)i+=l[e];return An(i)}),[n,l]),d=(0,i.useMemo)((()=>{const e=r(n[(null==n?void 0:n.indexOf(t))-1])+Mn(100,s),l=r(o)-Mn(100,s);return{min:An(e),max:An(l)}}),[t,o,n,s,r]),c=(0,i.useCallback)((e=>Number.isNaN(d.min)||Number.isNaN(d.max)?e:An(Math.min(Math.max(e,d.min),d.max))),[d]),u=(0,i.useCallback)(((e,i)=>{const r=c(Mn(i.x,s));if(r==d.min||r==d.max)return;const u=[...l],h=l[n.indexOf(t)]+i.deltaX/s*100,p=l[n.indexOf(o)]-i.deltaX/s*100;u[null==n?void 0:n.indexOf(t)]=An(h,2),u[null==n?void 0:n.indexOf(o)]=An(p,2),null==a||a(u)}),[s,l,n,d]);return(0,f.jsx)(Zn.DraggableCore,{onDrag:u,children:(0,f.jsx)(Pn,{left:c(r(t))})})};let zn,Bn,$n,Nn,Hn,Ln,In,Kn,_n=e=>e;const Un=a().div(zn||(zn=_n`
  font-size: var(--text-size-m);
...
`)),qn=a().div(Nn||(Nn=_n`
  ...
  border-right: var(--border-width-default) var(--border-style-solid)
    var(--border-color-default);
  background-color: ${0};
`),(e=>e.nonEditableToggles?"var(--background-color-secondary);":"inherit")),Gn=a().div(Hn||(Hn=_n`
  height: 30px;
  width: 0;
  position: absolute;
...
`)),el=a().div(Kn||(Kn=_n`
  ...
  margin: var(--spacing-zero);
  background-color: ${0};
`),(e=>e.isLastColumn?`0 1 ${e.columnWidth}%`:`0 0 ${e.columnWidth}%`),(e=>e.isNonEditable?"var(--background-color-secondary)":"inherit")),nl=new Map;nl.set("persistAll",{disabled:"You do not have permissions to perform this action.",default:"Persisting all values will replace all initial values with the current values of the variables."}),nl.set("resetAll",{default:"Resetting all values will replace all current values with the initial values of the variables."});const ll=(e,n,l)=>{let t;var i,o;return n&&(t=l||(null==(i=nl.get(e))?void 0:i.disabled)),t||(t=null==(o=nl.get(e))?void 0:o.default),t},tl=({allowedColumns:e,persistAll:n,disableVariablePersistAction:l,disablePersistActionTooltip:t,resetAll:i,disableVariableResetAction:o,disableResetActionTooltip:s})=>e.includes("sessionValue")?(0,f.jsx)(Xn,{children:(0,f.jsxs)(Ge.Z,{closeOnSelect:!1,children:[(0,f.jsx)(Je.Z,{"data-testid":"key-value-editor-more-actions-button",children:(0,f.jsx)(Qe.Z,{size:"small",icon:(0,f.jsx)(ln.Z,{size:"small"}),type:"tertiary",tooltip:"View more actions","data-testid":"more-options-button-column-header"})}),(0,f.jsxs)(en.Z,{children:[(0,f.jsx)(nn.Z,{onClick:n,isDisabled:l,tooltip:ll("persistAll",l,t),children:"Persist all"}),(0,f.jsx)(nn.Z,{onClick:i,isDisabled:o,tooltip:ll("resetAll",o,s),children:"Reset all"})]})]})}):null;function il(e){const{showColumns:n,currentWidth:l,handleWidthChange:t,keyHeading:o,valueHeading:s,descriptionHeading:a,sessionHeading:r,typeHeading:d,optionsHeading:c,allowedColumns:u,persistAll:h,resetAll:p,disableVariablePersistAction:b,disablePersistActionTooltip:g,disableVariableResetAction:v,disableResetActionTooltip:m}=e,x=(0,i.useRef)(null),[y,C]=(0,i.useState)(null);(0,i.useEffect)((()=>{const e=new ResizeObserver((e=>{C(e[0].contentRect.width)})),n=x.current;return e.observe(n),()=>{e.unobserve(n)}}),[]);const w=(0,i.useCallback)((n=>e[`nonEditable${T(n)}s`]),[e]),k=(0,i.useCallback)((e=>Number(l[null==n?void 0:n.indexOf(e)])),[n,l]);return(0,f.jsx)(Un,{role:"rowgroup",children:(0,f.jsxs)(Yn,{role:"row",children:[(0,f.jsx)(qn,{children:(0,f.jsx)(Gn,{})}),(0,f.jsxs)(Jn,{ref:x,children:[(0,f.jsx)(el,{type:"key",role:"columnheader",columnWidth:k("key"),isNonEditable:w("key"),isLastColumn:n&&"key"===n[n.length-1],children:(0,f.jsx)(Qn,{children:o||"Key"})}),(null==n?void 0:n.includes("variableType"))&&(0,f.jsxs)(f.Fragment,{children:[(0,f.jsx)(Fn,{handleResize:t,showColumns:n,currentWidth:l,prevColumn:"key",nextColumn:"variableType",parentWidth:y}),(0,f.jsx)(el,{type:"variableType",role:"columnheader",columnWidth:k("variableType"),isNonEditable:w("variableType"),isLastColumn:n&&"variableType"===n[n.length-1],children:(0,f.jsx)(Qn,{children:d||"Type"})})]}),(null==n?void 0:n.includes("value"))&&(0,f.jsxs)(f.Fragment,{children:[(0,f.jsx)(Fn,{handleResize:t,showColumns:n,currentWidth:l,prevColumn:n.includes("variableType")?"variableType":"key",nextColumn:"value",parentWidth:y}),(0,f.jsx)(el,{type:"value",role:"columnheader",columnWidth:k("value"),isNonEditable:w("value"),isLastColumn:n&&"value"===n[n.length-1],children:(0,f.jsx)(Qn,{children:s||"Value"})})]}),(null==n?void 0:n.includes("description"))&&(0,f.jsxs)(f.Fragment,{children:[(0,f.jsx)(Fn,{handleResize:t,showColumns:n,currentWidth:l,prevColumn:"value",nextColumn:"description",parentWidth:y}),(0,f.jsx)(el,{type:"description",role:"columnheader",columnWidth:k("description"),isNonEditable:w("description"),isLastColumn:n&&"description"===n[n.length-1],children:(0,f.jsx)(Qn,{children:a||"Description"})})]}),(null==n?void 0:n.includes("sessionValue"))&&(0,f.jsxs)(f.Fragment,{children:[(0,f.jsx)(Fn,{handleResize:t,showColumns:n,currentWidth:l,prevColumn:"value",nextColumn:"sessionValue",parentWidth:y}),(0,f.jsx)(el,{type:"sessionValue",role:"columnheader",columnWidth:k("sessionValue"),isNonEditable:w("sessionValue"),isLastColumn:n&&"sessionValue"===n[n.length-1],children:(0,f.jsx)(Qn,{children:r||"Current value"})})]}),u.includes("sessionValue")&&(0,f.jsx)(tl,{allowedColumns:u,persistAll:h,resetAll:p,disablePersistActionTooltip:g,disableResetActionTooltip:m,disableVariablePersistAction:b,disableVariableResetAction:v}),(null==n?void 0:n.includes("options"))&&(0,f.jsxs)(f.Fragment,{children:[(0,f.jsx)(Fn,{handleResize:t,showColumns:n,currentWidth:l,prevColumn:"value",nextColumn:"options",parentWidth:y}),(0,f.jsx)(el,{type:"options",role:"columnheader",columnWidth:k("options"),isNonEditable:w("options"),isLastColumn:n&&"options"===n[n.length-1],children:(0,f.jsx)(Qn,{children:c||"Options"})})]})]})]})})}const ol=["defaultValue","entityType","values","onChange","showColumns","nonEditableKeys","nonEditableValues","nonEditableDescriptions","nonEditableToggles","nonEditableOptions","keyHeading","valueHeading","sessionHeading","optionsHeading","optionsTooltip","nonEditableVariableTypes","hideBulkOptions","maskStatesMap","toggleMaskValue","initialColumnWidths","disableVariablePersistAction","disableVariableResetAction","disableSecretVariablesSync","disablePersistActionTooltip","disableResetActionTooltip","onDeleteRow","disallowDuplicates"];let sl;const al=a().div(sl||(sl=(e=>e)`
  display: flex;
  flex: 1;
  flex-direction: column;
  border-top: thin solid var(--border-color-default);
  min-height: 0;
`));function rl(e){let{defaultValue:n="",entityType:l,values:o,onChange:s,showColumns:a,nonEditableKeys:r,nonEditableValues:d,nonEditableDescriptions:u,nonEditableToggles:h,nonEditableOptions:p,keyHeading:b,valueHeading:g,sessionHeading:v,optionsHeading:m,optionsTooltip:x,nonEditableVariableTypes:y,hideBulkOptions:C,maskStatesMap:w,toggleMaskValue:k,initialColumnWidths:j,disableVariablePersistAction:V,disableVariableResetAction:E,disableSecretVariablesSync:S,disablePersistActionTooltip:T,disableResetActionTooltip:D,onDeleteRow:R,disallowDuplicates:Z}=e,M=(0,c.Z)(e,ol);const A={showColumns:a,allowedColumns:M.allowedColumns,nonEditableKeys:r,nonEditableValues:d,nonEditableDescriptions:u,nonEditableToggles:h,nonEditableOptions:p,hideBulkOptions:C},W=(0,i.useRef)(s);W.current=s;const[O,P]=(0,i.useState)(function(e,n){let l;return n?l=n:(l=new Array(e.length).fill(Math.floor(100/e.length)),l[l.length-1]=l.at(-1)+(100-l.reduce(((e,n)=>e+n)))),l}(a,j)),F=(0,i.useCallback)(((e,t={})=>{let i="text";"environment"!==l&&"globals"!==l||(i="default"),"collection"===l&&(i="string");const o={key:t.key||n,value:t.value||n,description:t.description||n,type:t.type||i,id:e};return M.allowedColumns.includes("sessionValue")&&(o.sessionValue=t.sessionValue||null),M.disableToggle||(o.enabled=!0),o}),[n,M.disableToggle,l,M.allowedColumns]),z=(0,i.useCallback)((()=>{if(o.length>0){var e=null==o?void 0:o.reduce((function(e,n){return e.id>=n.id?e:n}),{});return n=e,[Object,Array].includes((n||{}).constructor)&&0===Object.entries(n||{}).length?0:e.id+1}var n;return 0}),[o]),B=(0,i.useCallback)(((e,n)=>{const l=[...o],i=l.length===e?[...l,F(z(),n)]:l.map((l=>l.id===e?(0,t.Z)({},l,n):(0,t.Z)({},l)));null==W.current||W.current(i)}),[o,F,z]),$=(0,i.useCallback)((e=>{const n=[...o],l=null==n?void 0:n.filter(((n={})=>n.id!==e));R&&R(e),null==W.current||W.current(l)}),[o,R]),N=(0,f.jsx)(il,(0,t.Z)({},A,{keyHeading:b||"Key",valueHeading:g||"Value",sessionHeading:v||"Current value",optionsHeading:m||"Options",optionsTooltip:x,nonEditableVariableTypes:y,handleWidthChange:P,currentWidth:O,persistAll:()=>{if(V)return;let e=!1;const n=o.reduce(((n,l)=>{const i=l.enabled?l.sessionValue:l.value;return l.isSessionValueDeleted?(e=!0,n):(!e&&(e=!(S&&l.type===te)),S&&l.type===te?n.push(l):n.push((0,t.Z)({},l,{value:i})),n)}),[]);e&&(null==W.current||W.current(n))},resetAll:()=>{if(E)return;let e=!1;const n=o.map((n=>{const l=n.enabled?n.value:n.sessionValue;return S&&n.type===te?n:(e=!0,(0,t.Z)({},n,{sessionValue:l,isSessionValueDeleted:!1}))}));e&&(null==W.current||W.current(n))},disableVariablePersistAction:V,disableVariableResetAction:E,disablePersistActionTooltip:T,disableResetActionTooltip:D})),H=(0,i.useMemo)((()=>M.disableCreate?o:[...o,F(z())]),[o,M.disableCreate,F,z]),L=(0,i.useMemo)((()=>Z?H.map(((e,n)=>{if(e.enabled&&""!==e.key)for(let l=n+1;l<H.length;l++){const n=H[l];if(e.key===n.key&&n.enabled&&""!==n.key)return(0,t.Z)({},e,{isOverridden:!0})}return(0,t.Z)({},e,{isOverridden:!1})})):null),[H,Z]);return(0,f.jsxs)(al,{children:[o.length>0||!M.disableCreate?N:null,(0,f.jsx)(Rn,(0,t.Z)({},A,M,{nonEditableVariableTypes:y,values:H,onChange:B,onRemove:$,currentWidth:O,maskStatesMap:w,toggleMaskValue:k,onPersist:e=>{if(V)return;let n=!1;const l=o.reduce(((l,i)=>{if(i.id===e){if(i.isSessionValueDeleted)return n=!0,l;S&&i.type===te?l.push(i):(n=!0,l.push((0,t.Z)({},i,{value:i.sessionValue})))}else l.push(i);return l}),[]);n&&(null==W.current||W.current(l))},onReset:e=>{if(E)return;let n=!1;const l=o.map((l=>l.id!==e||S&&l.type===te?l:(n=!0,(0,t.Z)({},l,{sessionValue:l.value,isSessionValueDeleted:!1}))));n&&(null==W.current||W.current(l))},onBlur:(e,n,l)=>{const i=o.findIndex((n=>n.id===e)),s=-1!==i&&o[i].sessionValue;let a;"value"===n&&-1!==i&&null===s&&l.value&&(a=[...o],a[i]=(0,t.Z)({},l,{sessionValue:l.value}),null==W.current||W.current(a))},disableVariablePersistAction:V,disableVariableResetAction:E,disableSecretVariablesSync:S,disablePersistActionTooltip:T,disableResetActionTooltip:D,duplicateWarningsMap:L}))]})}var dl=l(68206);const cl=F(((e,...n)=>e(...n)),100),ul=({onSearchValueChange:e})=>{const[n,l]=(0,i.useState)("");return(0,f.jsx)("div",{className:"search-variable",children:(0,f.jsx)(dl.Z,{placeholder:"Filter variables",value:n,type:"search",onChange:n=>{l(n.target.value),cl(e,n.target.value)},onClear:()=>{l(""),e("")},prefix:!0,name:"filter-values"})})};function hl(e,n){try{const l=(0,ce.castNonStringTypesToString)(e),t=(0,ce.castNonStringTypesToString)(n),i=l.toLowerCase(),o=t.toLowerCase();return i.indexOf(o)}catch(l){return console.error("PatterSearch~caseInsensitiveIndexof: Failed with error",l,e,n),-1}}let pl;const bl=a().div(pl||(pl=(e=>e)`
